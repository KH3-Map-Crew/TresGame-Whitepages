...
* <ins>TaskAction (Tres)</ins>: Lets you set a state. You can also set a target actor.

  ![task action](./images/BehaviorTree/TaskAction.png)

* <ins>TaskMoveTo (Tres)</ins>: Moves the pawn to the location. You can use any actor, comp, or vector.
