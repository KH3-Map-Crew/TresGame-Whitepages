...
### <ins>Navmesh</ins>: 
While I don’t plan on going in depth on navmesh in this guide due to existing in other guides, navmesh is how AI determine to move around on the ground. You can generate them in engine on your maps.   
### <ins>Mercuna</ins>: 
Flying/swimming characters use Mercuna for navigation, which is not able to be built in engine for maps. However, if you want to make a flying character, you can and must add a mercuna navigation comp to the pawn.  
### <ins>Controller</ins>: 
AI pawns are possessed by an ai controller. Other than for making npcs swimming, I have never needed to change or modify a controller. You should leave this as default to whatever class of pawn you use.

# Importing Cooked AI Assets

Using the current KH-Built Unreal Engine, you can backwards import certain cooked AI assets. Follow the guide linked here.

[Import Cooked AI Assets](../AICooked.md)